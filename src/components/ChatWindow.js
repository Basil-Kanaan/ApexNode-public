            ...
            <div style={{ maxHeight: '70vh', overflowY: 'auto', marginTop: '1rem' }}>
                {messages.map((msg, index) => (
                    <div key={index} style={{ textAlign: msg.sender === 'user' ? 'right' : 'left' }}>
                        <Typography variant="body1" style={{ backgroundColor: msg.sender === 'user' ? '#2196F3' : '#f0f0f0', padding: '0.5rem', borderRadius: '5px', marginBottom: '0.5rem', display: 'inline-block', maxWidth: '70%' }}>
                            {msg.text}
                        </Typography>
                    </div>
                ))}
