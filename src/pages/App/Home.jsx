            ...
            <Grid container spacing={3}>
                <Grid item xs={12} sm={6} md={4}>
                    <Paper elevation={3} sx={{ p: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', height: '100%' }}>
                        ...
                        <Button onClick={handleViewProjects} variant="outlined" color="primary" sx={{ marginTop: 'auto' }}>
                            View Projects
                        </Button>
                    </Paper>
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                    <Paper elevation={3} sx={{ p: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', height: '100%' }}>
                        ...
                        <Button onClick={handleViewMessages} variant="outlined" color="primary" sx={{ marginTop: 'auto' }}>
                            View Messages
                        </Button>
                    </Paper>
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                    <Paper elevation={3} sx={{ p: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', height: '100%' }}>
                        ...
                        <Typography variant="body1">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam auctor, est vel tincidunt tincidunt, sem ex interdum eros.
                        </Typography>
